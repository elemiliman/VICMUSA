		...
		<div class="span8">
			<div class="row-fluid">
				<table class="table table-striped table-bordered">
					...
					<tbody>
					<c:forEach items="${sermons}" var="sermon" varStatus="loopStatus">
							...
							<td><a href="/sermons/teacher/${sermon.user.userName}"><c:out value="${sermon.user.firstName}" /> <c:out value="${sermon.user.lastName}" /></a></td>
						</tr>
					</c:forEach>
					<tr>
					</tbody>
